...
- 🎓 Undergraduate at Xi'an Jiaotong University's Youth Gifted Program (少年班), majoring in **Artificial Intelligence**
- 🤖 Passionate about **LLMs / AI Agents / Agent infrastructure** and **full-stack application development**
...
| Project                                                           | Description                                                                                                                                                           |
| ----------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**XJTUToolBox**](https://github.com/fyc09/XJTUToolBox)           | 仙交百宝箱 — an all-in-one desktop toolkit for XJTU students: attendance & transcript lookup, course schedule, one-click course evaluation, and more                       |
| [**pi-weixin-bridge**](https://github.com/fyc09/pi-weixin-bridge) | Plugin that connects **Pi Agent** to **WeChat** via WeChat's official ClawBot / iLink API — scan to connect, two-way transfer of text / images / files / videos       |
| [**livems**](https://github.com/fyc09/livems)                     | Life management system (schedules / todos / courses / files / notes) that I am currently using                                                                        |
| [**AgentLabX**](https://github.com/fyc09/AgentLabX)               | Research-style agent experiment orchestration: multi-agent peer-review loop built on AgentTeams, four-dimension evaluation driving iterative optimization (GOAI 2026) |
| [**iribot**](https://github.com/fyc09/iribot)                     | Lightweight AI Agent Chat System                                                                                                                                      |
...
<p align="center">
  <i>Always exploring, always building. Thanks for stopping by! ✨</i>
  <br/><br/>
  <img src="https://komarev.com/ghpvc/?username=fyc09&color=blueviolet&style=flat-square" alt="Profile views" />
</p>
